...
{
  AssertionResultData()
          : decomposedExpression(CATCH_NULL), resultType(ResultWas::Unknown), negated(false), parenthesized(false)
  {
  }
...
class TestSpecParser
{
 ...
 public:
  TestSpecParser(ITagAliasRegistry const &tagAliases)
          : m_mode(None), m_exclusion(false), m_start(0), m_pos(0), m_tagAliases(&tagAliases)
  {
  }
 ...
 public:
  ...
  virtual void close() CATCH_OVERRIDE
  {
      ...
      switch (m_runState)
      {
          ...
          case Failed:throw std::logic_error("Illogical state");
          ...
          default:throw std::logic_error("Unexpected state");
      }
      moveToParent();
      m_ctx.completeCycle();
  }
...
inline std::vector<TestCase> sortTests(IConfig const &config, std::vector<TestCase> const &unsortedTestCases)
{
    ...
    {
        case RunTests::InLexicographicalOrder:std::sort(sorted.begin(), sorted.end());
            break;
...
class RegistryHub : public IRegistryHub, public IMutableRegistryHub
{
 ...
 public: // IMutableRegistryHub
  ...
  virtual void
  registerTagAlias(std::string const &alias, std::string const &tag, SourceLineInfo const &lineInfo) CATCH_OVERRIDE
  {
...
AssertionInfo::AssertionInfo()
        : macroName(""), capturedExpression(""), resultDisposition(ResultDisposition::Normal), secondArg("")
{
}
    ...
    void print()
    {
        ...
        switch (result.getResultType())
        {
            ...
            case ResultWas::ExpressionFailed:
                ...
                printRemainingMessages();
                break;
            case ResultWas::ThrewException:printResultType(Colour::Error, failedString());
                printIssue("unexpected exception with message:");
                printMessage();
                printExpressionWas();
                printRemainingMessages();
                break;
            case ResultWas::FatalErrorCondition:printResultType(Colour::Error, failedString());
                printIssue("fatal error condition with message:");
                printMessage();
                printExpressionWas();
                printRemainingMessages();
                break;
            case ResultWas::DidntThrowException:printResultType(Colour::Error, failedString());
            ...
            case ResultWas::Warning:printResultType(Colour::None, "warning");
                ...
                printRemainingMessages();
                break;
            case ResultWas::ExplicitFailure:printResultType(Colour::Error, failedString());
